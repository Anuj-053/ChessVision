    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background:'var(--bg-base)' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold text-white">Notation Mode</h1>
          <p className="text-sm mt-1" style={{ color:'var(--text-3)' }}>Full board visible — practise reading algebraic notation</p>
        </div>
        <div className="glass-raised rounded-2xl p-5 space-y-5">
          ...
          <button onClick={startGame} className="btn-gold w-full py-3 rounded-xl font-semibold">Start Game</button>
        </div>
      </div>
    </div>
  )
